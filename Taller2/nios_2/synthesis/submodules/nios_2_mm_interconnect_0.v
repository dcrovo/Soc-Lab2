...
module nios_2_mm_interconnect_0 (
	...
	wire   [5:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> onchip_mem_s1_agent:cp_channel
	...
	wire  [93:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> button_s1_agent:cp_data
	...
	wire  [93:0] sysid_control_slave_agent_rp_data;                                         // sysid_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [93:0] button_s1_agent_rp_data;                                                   // button_s1_agent:rp_data -> router_007:sink_data
	...
	nios_2_mm_interconnect_0_router router_001 (
	...
	nios_2_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_2_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_2_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_2_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
