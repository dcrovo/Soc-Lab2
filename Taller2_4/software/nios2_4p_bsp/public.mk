...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios2_p4.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x210e8
SOPC_SYSID_FLAG += --sidp=0x210e8
ELF_PATCH_FLAG  += --sidp 0x210e8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1663736715
SOPC_SYSID_FLAG += --timestamp=1663736715
ELF_PATCH_FLAG  += --timestamp 1663736715
